...
/*
 * Proxy class for interface org.audioforge.jamesdsp.Gui
 */
class OrgAudioforgeJamesdspGuiInterface: public QDBusAbstractInterface
{
    Q_OBJECT
public:
    static inline const char *staticInterfaceName()
    { return "org.audioforge.jamesdsp.Gui"; }

public:
    OrgAudioforgeJamesdspGuiInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);

    ~OrgAudioforgeJamesdspGuiInterface();
...
/*
 * Proxy class for interface org.audioforge.jamesdsp.Service
 */
class OrgAudioforgeJamesdspServiceInterface: public QDBusAbstractInterface
{
    Q_OBJECT
public:
    static inline const char *staticInterfaceName()
    { return "org.audioforge.jamesdsp.Service"; }

public:
    OrgAudioforgeJamesdspServiceInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);

    ~OrgAudioforgeJamesdspServiceInterface();
...
namespace org {
  namespace audioforge {
    namespace jamesdsp {
      typedef ::OrgAudioforgeJamesdspGuiInterface Gui;
      typedef ::OrgAudioforgeJamesdspServiceInterface Service;
    }
  }
}
#endif
